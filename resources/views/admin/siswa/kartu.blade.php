        ...
        <div class="card">
            <div class="school-header">
                ...
                <div class="school-name">
                    <strong>{{ config('app.name', 'LaraSchool') }}</strong>
                    Kartu Pelajar
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="photo">
                    <img src="{{ $siswa->foto ? asset('uploads/siswa/'.$siswa->foto) : 'https://ui-avatars.com/api/?name='.urlencode($siswa->nama_lengkap).'&background=4c1d95&color=fff&size=200' }}" alt="Foto">
                </div>
                <div class="info">
                    <div class="info-row">
                        <label>Nama Lengkap</label>
                        <span>{{ strtoupper($siswa->nama_lengkap) }}</span>
                    </div>
            ...
            <div class="card-footer">
                <span>Berlaku Tahun Ajaran {{ date('Y') }}/{{ date('Y')+1 }}</span>
