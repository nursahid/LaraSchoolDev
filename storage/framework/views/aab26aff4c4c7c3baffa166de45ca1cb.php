...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — <?php echo e(config('app.name', 'LaraSchool')); ?></title>
...
<body class="h-full bg-gradient-to-br from-indigo-950 via-purple-950 to-indigo-900 min-h-screen"
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'"
        ...
        <nav class="flex-1 overflow-y-auto py-4 space-y-0.5 px-2">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.config.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.config.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.aktivitas.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.aktivitas.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.menu-manager.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.menu-manager.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.pegawai.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.pegawai.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.pegawai-mapel.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.pegawai-mapel.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.siswa.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.siswa.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.kelas.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.kelas.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.mapel.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.mapel.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.mapel-tingkat.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.mapel-tingkat.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.tahunajaran.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.tahunajaran.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.jadwal.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.jadwal.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.absensi.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.absensi.index') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.nilai.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.nilai.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.prestasi.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.prestasi.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.absensi.laporan')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.absensi.laporan') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.nilai.index')); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-purple-100 text-sm transition-all <?php echo e(request()->routeIs('admin.nilai.index') ? 'active' : ''); ?>">
        ...
        <div class="border-t border-white/10 p-3 flex-shrink-0">
            <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-violet-400 to-purple-600 flex items-center justify-center flex-shrink-0">
                    <span class="text-white text-xs font-bold"><?php echo e(substr(Auth::user()->name ?? 'A', 0, 1)); ?></span>
                </div>
                <div x-show="sidebarOpen" class="overflow-hidden flex-1" x-transition>
                    ...
                    <p class="text-purple-300 text-xs truncate"><?php echo e(Auth::user()->email ?? ''); ?></p>
                </div>
    ...
    <div :class="sidebarOpen ? 'lg:pl-64' : 'lg:pl-16'" class="flex flex-col min-h-screen transition-all duration-300">
        ...
        <header class="sticky top-0 z-10 flex items-center h-16 bg-white/10 backdrop-blur-md border-b border-white/10 px-4">
            ...
            <div class="flex-1">
                <h1 class="text-white font-semibold text-base"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="hidden sm:inline-flex items-center gap-1 px-3 py-1 rounded-full bg-white/10 text-purple-200 text-xs font-medium border border-white/20">
                    <i class="fas fa-calendar-alt"></i> <?php echo e(session('tapel_aktif')); ?>
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center gap-2 text-sm text-white/80 hover:text-white transition-colors">
                        ...
                        <span class="hidden sm:block font-medium"><?php echo e(Auth::user()->name ?? 'Admin'); ?></span>
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <a href="<?php echo e(route('admin.profile')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-purple-100 hover:bg-white/10 hover:text-white">
                            <i class="fas fa-user-circle w-4"></i> Profil Saya
                        </a>
                        <a href="<?php echo e(route('admin.config.index')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-purple-100 hover:bg-white/10 hover:text-white">
        ...
        <footer class="py-4 px-6 border-t border-white/10">
            <p class="text-center text-xs text-purple-400">
                &copy; <?php echo e(date('Y')); ?> LaraSchool — SMPN 3 Mepanga. Semua Hak Dilindungi.
            </p>
        </footer>
    </div>
...
<?php /**PATH D:\www\laravel\laraschool\resources\views/layouts/admin.blade.php ENDPATH**/ ?>